...
import "../style/AccessoriesList.css"; // Tu peux le renommer en style/WomenList.css si tu veux séparer
        ...
        <div className="accessory-list-page">
            ...
            <main className="accessory-main-content">
                <section className="featured-accessories">
                    <h2 className="section-title">Women's Products</h2>
                        ...
                        {!loading && currentItems.length > 0 ? (
                            currentItems.map((item) => (
                                <div key={item._id} className="accessory-card">
                                    ...
                                    <h3>{item.title}</h3>
                                    <p>{item.price}</p>
                                    <Link to={`/women/${item._id}`} className="view-product-link">
                                        View Product
                                    </Link>
                                </div>
                            ))
