...
import "../../style/PostLoginUser/productlist_postloguser.css";
        ...
        <div className="product-list-page">
            <nav className="navbar3">
                    ...
                    <form className="search-form3">
                        ...
                        />
                        <button type="submit" className="search-icon-btn3">
                    ...
                    <div className="nav-buttons3">
                        <Link to="/profile_user" className="login-btn2">Profile</Link>
                    </div>
                </nav>
